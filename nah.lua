		...
		task.spawn(
			function()
				if tick() - cdnormal > 0.999 then
					...
					ac.humanoid:LoadAnimation(Animation):Play(125, 250) --à¸—à¹ˆà¸²à¹„à¸¡à¹ˆà¸—à¸³à¸‡à¸²à¸™à¹à¸à¹‰à¹€à¸›à¹‡à¸™ (1,1)
...
Set:AddLabel({
    Name = "[âœ…] : Enabled Config"
})
Set:AddLabel({
    Name = "[âœ…] : Enabled Auto Farm"
})
Set:AddLabel({
    Name = "[âœ…] : Enabled Fast Attack"
})
Set:AddLabel({
    Name = "[âœ…] : Enabled Bypass TP"
})
Set:AddLabel({
    Name = "[âœ…] : Enabled Double Quest"
})
