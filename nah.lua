...
pcall(function()
    ...
    status_fragment = Status:AddLabel({Name="Fragment : Æ’ "..game:GetService("Players").LocalPlayer.Data.Fragments.Value})
end)
spawn(function()
    while task.wait() do
        pcall(function()
            ...
            status_fragment:Set("Fragment : Æ’ "..game:GetService("Players").LocalPlayer.Data.Fragments.Value)
        end)
    end
end)
...
status_sup = Fighting_Style:AddLabel({Name="âŒ : Superhuman"})
status_dragon = Fighting_Style:AddLabel({Name="âŒ : DragonTalon"})
status_sharkman = Fighting_Style:AddLabel({Name="âŒ : SharkmanKarate"})
status_death = Fighting_Style:AddLabel({Name="âŒ : DeathStep"})
status_elect = Fighting_Style:AddLabel({Name="âŒ : ElectricClaw"})
status_god = Fighting_Style:AddLabel({Name="âŒ : Godhuman"})
...
status_bartilo = status_quest:AddLabel("âŒ : Quest Bartlio")
status_swan = status_quest:AddLabel("âŒ : Quest Open Don Swan")
status_phoenix = status_quest:AddLabel("âŒ : Quest Phoenix Awaken") 
status_obser = status_quest:AddLabel("âŒ : Quest Observation Haki")
status_observ2 = status_quest:AddLabel("âŒ : Quest Observation Haki V2")

local Sword = Main:CreateSection({
    Name = "Sword",
    Side = "Right"
})
status_shisui = Sword:AddLabel({Name="âŒ : Shisui"})
status_saidi = Sword:AddLabel({Name="âŒ : Saddi"})
status_wando = Sword:AddLabel({Name="âŒ : Wando"})
status_spikey = Sword:AddLabel({Name="âŒ : Spikey Trident"})
status_rengoku = Sword:AddLabel({Name="âŒ : Rengoku"})
status_saber = Sword:AddLabel({Name="âŒ : Saber"})
status_yama = Sword:AddLabel({Name="âŒ : Yama"})
status_tushita = Sword:AddLabel({Name="âŒ : Tushita"})
status_midnight = Sword:AddLabel({Name="âŒ : Midnight Blade"})
status_buddy = Sword:AddLabel({Name="âŒ : Buddy Sword"})
status_Canvander = Sword:AddLabel({Name="âŒ : Canvander"})
status_twin = Sword:AddLabel({Name="âŒ : Twin Hooks"})
status_pole = Sword:AddLabel({Name="âŒ : Pole"})
status_truetriple = Sword:AddLabel({Name="âŒ : True Triple Katana"})

local Gun = Main:CreateSection({
    Name = "Gun",
    Side = "Right"
})
status_serpent = Gun:AddLabel({Name="âŒ : Serpent Bow"})
status_kabucha = Gun:AddLabel({Name="âŒ : Kabucha"})
status_Acidumrifle = Gun:AddLabel({Name="âŒ : Acidum Rifie"})

local Accessory = Main:CreateSection({
    Name = "Accessory",
    Side = "Right"
})
status_darkcoat = Accessory:AddLabel({Name="âŒ : Dark Coat"})
status_musketeerhat = Accessory:AddLabel({Name="âŒ : Musketeer Hat"})
status_palescarf = Accessory:AddLabel({Name="âŒ : Pale Scarf"})
status_valkyrie = Accessory:AddLabel({Name="âŒ : Valkyrie Helm"})
