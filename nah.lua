...
-----------
Superhuman = KaiTun:AddLabel({Name = "âŒ : Superhuman"})
DeathStep = KaiTun:AddLabel({Name = "âŒ : Death Step"})
SharkmanKarate = KaiTun:AddLabel({Name = "âŒ : Sharkman Karate"})
ElectricClaw = KaiTun:AddLabel({Name = "âŒ : Electric Claw"})
DragonTalon = KaiTun:AddLabel({Name = "âŒ : Dragon Talon"})
GodHuman = KaiTun:AddLabel({Name = "âŒ : God Human"})
-----------
Shisui = KaiTun:AddLabel({Name = "âŒ : Shisui"})
Saddi = KaiTun:AddLabel({Name = "âŒ : Saddi"})
Wando = KaiTun:AddLabel({Name = "âŒ : Wando"})
TrueTripleKatana = KaiTun:AddLabel({Name = "âŒ : True Triple Katana"})
Saber = KaiTun:AddLabel({Name = "âŒ : Saber"})
Rengoku = KaiTun:AddLabel({Name = "âŒ : Rengoku"})
MidnightBlade = KaiTun:AddLabel({Name = "âŒ : Midnight Blade"})
DragonTrident = KaiTun:AddLabel({Name = "âŒ : DragonTrident"})
Yama = KaiTun:AddLabel({Name = "âŒ : Yama"})
BuddySword = KaiTun:AddLabel({Name = "âŒ : Buddy Sword"})
Canvander = KaiTun:AddLabel({Name = "âŒ : Canvander"})
TwinHooks = KaiTun:AddLabel({Name = "âŒ : Twin Hooks"})
SpikeyTrident = KaiTun:AddLabel({Name = "âŒ : Spikey Trident"})
HallowScythe = KaiTun:AddLabel({Name = "âŒ : Hallow Scythe"})
DarkDagger = KaiTun:AddLabel({Name = "âŒ : Dark Dagger"})
Tushita = KaiTun:AddLabel({Name = "âŒ : Tushita"})
-----------
Kabucha = KaiTun:AddLabel({Name = "âŒ : Kabucha"})
AcidumRifle = KaiTun:AddLabel({Name = "âŒ : Acidum Rifle"})
BizarreRifle = KaiTun:AddLabel({Name = "âŒ : Bizarre Rifle"})
-----------
BartiloQuest = KaiTun:AddLabel({Name = "âŒ : Bartilo Quest"})
DonSwanQuest = KaiTun:AddLabel({Name = "âŒ : Don Swan Quest"})
KillDonSwan = KaiTun:AddLabel({Name = "âŒ : Kill Don Swan"})
