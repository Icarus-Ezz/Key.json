...
_G.Setting = {
    UI = {
        ...
        ["ElementText"] = Color3.fromRGB(255, 17, 0),
        ...
        ["TabText"] = Color3.fromRGB(255, 17, 0)
    }
}
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/vuquocoai123/lua/main/UiPesi.txt"))()
local Wait = library.subs.Wait

local PepsiUi = library:CreateWindow({
    Name = "Night Hub - Kaitan Script",
    Theme = {
        Image = "rbxassetid://7483871523",
        Info = "Info",
        Background = {
            Asset = "rbxassetid://14802234790"
        }
    }
})
...
local Melee = Main:CreateSection({
    Name = "[ Fighting Style ]",
    Side = "Left"
})
...
local Kaitan = Main:CreateSection({
    Name = "[ Kaitan ]",
    Side = "Right"
})
local World = Main:CreateSection({
    Name = "[ World ]",
    Side = "Right"
})
local WolrdSet3 = World:AddLabel({
    Name = "[âŒ] : Unlock Wolrd 1 "
})
task.spawn(
    function()
        pcall(
            function()
                while wait() do
                    if game.PlaceId == 2753915549 then
                        WolrdSet3:Set("[âœ…] : Unlock Wolrd 1")
					elseif game.PlaceId == 4442272183 then 
						WolrdSet3:Set("[âœ…] : Unlock Wolrd 1") 
					elseif game.PlaceId == 7449423635 then 
						WolrdSet3:Set("[âœ…] : Unlock Wolrd 1") 
            ...
            function()
                while wait() do
                    if game.PlaceId == 4442272183 then
                        WolrdSet:Set("[âœ…] : Unlock Wolrd 2 ")
					elseif game.PlaceId == 7449423635 then 
						WolrdSet:Set("[âœ…] : Unlock Wolrd 2")
                    end
                end
            ...
            function()
                while wait() do
                    if game.PlaceId == 7449423635 then
                        WolrdSet1:Set("[âœ…] : Unlock Wolrd 3")
                    end
                end
            end
        )
...
local LegenSword =  Main:CreateSection({
...
local Ss = Kaitan:AddLabel({
    Name = "Stutas Farm : -"
})
local Farm = Kaitan:AddLabel({
    Name = "Stutas Farm : "
})
...
Kaitan:AddToggle({
    ...
    Callback = function(value)
       ...
       _G.StartKaitan = value
	   getgenv().DisnableDame = value
	   getgenv().removeheavy = value
	   getgenv().remove = value
...
setfpscap(99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999)
			...
			STOPRL.wrapAttackAnimationAsync = function(a,b,c,d,func)
				...
				if Hits then
					if _G.RemoveAnimation or _G.AutoKaitan or _G.Auto_Farm_Level then
					       if _G.AutoKaitan or _G.Auto_Farm_Level or _G.FastAttack then
