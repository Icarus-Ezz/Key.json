...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Phatdepzaicrystal/phatsadboizbuonba/refs/heads/main/Main/Test.lua?token=GHSAT0AAAAAAC5UN6N4SAPPTWADD442E5QUZ6VGI6A"))()
]] --
                                ...
                                if
                                 ...
                                 then
                                    if not game:GetService("Workspace").Boats:FindFirstChild("PirateGrandBrigade") then
                                        buyb =
                                            TweenBoat(CFrame.new(-16916.537109375, 9.725836753845215, 511.4018859863281))
                                        if
                                            (CFrame.new(-16916.537109375, 9.725836753845215, 511.4018859863281).Position -
                                                game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <=
                                                10
                                         then
                                            if buyb then
    ...
    function(state)
        ...
        if state then
            ...
            delay(
                ...
                function()
                    if
                        (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(-16927, 9, 433)).Magnitude <=
                            10
                     then
...
local AutoDragonHunter =
    Tabs.Volcanic:AddToggle("AutoDragonHunter", {Title = "Tween To Dragon Hunter", Default = false})
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Get Fruit Under 1M Beli", Default = false})
